  ...
  return (
    <div className="relative">
      <input
        ...
        className=" w-full rounded-md bg-secondary py-1.5 pl-3 pr-10 text-left shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary sm:text-sm sm:leading-6"
      />
      <span
